...
- https://github.com/arduino/app-bricks-examples/tree/main/examples/bedtime-story-teller
...
## Device Template
- Template code: `UnoQBST`
- Template name: `UnoQBedtimeStoryTeller`
...
2) Run the patcher from the workshop repo:
   ```bash
   ./scripts/unoq_patch_app.sh /home/arduino/ArduinoApps/bedtime-story-teller
   ```
