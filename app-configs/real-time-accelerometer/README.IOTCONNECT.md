...
- https://github.com/arduino/app-bricks-examples/tree/main/examples/real-time-accelerometer
...
## Device Template
- Template code: `UnoQRTA`
- Template name: `UnoQRealTimeAcceleromete`
...
2) Run the patcher from the workshop repo:
   ```bash
   ./scripts/unoq_patch_app.sh /home/arduino/ArduinoApps/real-time-accelerometer
   ```
